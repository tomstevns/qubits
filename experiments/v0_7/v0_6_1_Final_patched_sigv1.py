...
# -*- coding: utf-8 -*-
"""
v0_6_1_Final_patched_sigV1.py — Systematic Signature Detection (v0_6.1) with evidence-hygiene output
...
def main() -> None:
    ...
    ap.add_argument("--output", type=str, default="v0_6_1_Final_patched__sigV1_output.txt")
