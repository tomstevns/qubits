...
# -*- coding: utf-8 -*-
"""
v0_7_convergence_families_v16.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="v0_7 convergence harness v16 (n_qubits=4 default; cached Pauli ops; dim-aware coarse bins).")
    ...
    ap.add_argument("--output", type=str, default="v0_7_convergence_families_v16_output.txt")
    args = ap.parse_args()
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration (v16) ===")
