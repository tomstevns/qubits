...
- Perturbation robustness (v21.1): apply the *same* small Hermitian perturbation ΔH in the
...
def main() -> None:
    ...
    ap.add_argument("--output", type=str, default="v0_7_convergence_families_v21.1_output.txt")
    args = ap.parse_args()
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration + Perturbation Robustness + Gap/Isolation (v21.1) ===")
